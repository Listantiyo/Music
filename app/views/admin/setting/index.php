        ...
        <div class="card-body row">
            <div class="col">
                ...
                <div class="row">
                    ...
                    <div class="input-group mb-3 col-12 d-flex justify-content-end">
                        <?php if (isset($data['old_setting']['logo'])) { ?>
                            <img width="100rem" height="80rem" src="<?= BASEPATH;
                ...
                <div class="input-group mb-3">
                    <textarea name="addres" class="form-control" aria-label="With textarea"><?php if (isset($data['old_setting']['addres'])) echo $data['old_setting']['addres']; ?></textarea>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="input-group mb-3 col-6">
                        ...
                        <div class="input-group-append">
                            <span class="input-group-text" id="basic-addon2">yt</span>
                        </div>
                    </div>
                </div>

                <label for="basic-url">Slide Text</label>
                <div class="row">
                    ...
                    <div class="input-group mb-3 col-12">
                        <div class="input-group-prepend">
                            <span class="input-group-text">Slide textarea</span>
                        </div>
